...
bot.onText(/^\/start$/, (msg) => {
    ...
    `📢 Telegram канал разработчика: @darkcoder15sc\n📜 Исходный код бота на GitHub: https://github.com/DarkCoder15/ffmpegtgbot`, {
